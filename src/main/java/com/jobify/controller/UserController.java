...
public class UserController {
    ...
    @Operation(summary = "Register a new user",
               description = "A POST request to register users",
    ...
    @Operation(summary = "User login",
               description = "A POST request for logging-in a user",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully logged-in the user"),
      @ApiResponse(responseCode = "403", description = "Log-in unsuccessful"),
      @ApiResponse(responseCode = "400", description = "Input Validation Failed"),
      @ApiResponse(responseCode = "500", description = "Some Exception Occurred")})
    ...
    @Operation(summary = "Search user by keyword",
               description = "A GET request to search users",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, List<UserApiResponse>>> searchUserBy(@RequestParam(value = "search", required = false) String searchVal) {
    ...
    @Operation(summary = "Get user by username",
               description = "A GET request to get user by username",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully found user"),
      @ApiResponse(responseCode = "404", description = "User not found"),
    ...
    @Operation(summary = "Get user by userId",
               description = "A GET request to get user by userId",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully found user"),
      @ApiResponse(responseCode = "404", description = "User not found"),
    ...
    @Operation(summary = "Update user by userId",
               description = "A PUT request to update user",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Export user's data in Csv",
               description = "A GET request to download user's list in a Csv file",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully found all the users"),
      @ApiResponse(responseCode = "500", description = "Some Exception Occurred")})
    ...
    @Operation(summary = "Export user's data in Excel",
               description = "A GET request to download user's list in a Excel file",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully found all the users"),
      @ApiResponse(responseCode = "500", description = "Some Exception Occurred")})
    ...
    @Operation(summary = "Export user's data in Pdf",
               description = "A GET request to download user's list in a Pdf file",
               tags = {"Jobify User Service"})
    @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully found all the users"),
      @ApiResponse(responseCode = "500", description = "Some Exception Occurred")})
